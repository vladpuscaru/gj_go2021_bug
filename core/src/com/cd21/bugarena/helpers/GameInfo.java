package com.cd21.bugarena.helpers;
...
public class GameInfo {
    ...
    public static final float PLAYER_SPEED = 50.0f;
    public static final float PLAYER_DASH_SPEED_ADDITION = 1.5f;
    public static final float PLAYER_SPEED_DECREASE = 15.0f;
}
